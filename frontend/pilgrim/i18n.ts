...
// --- Intent (triage) + self-lost screens (after language) ---
export interface IntentStrings {
  title: string;
  someoneLost: string;
  someoneLostSub: string;
  iAmLost: string;
  iAmLostSub: string;
  nearby: string;
  locating: string;
...
const INTENT: Record<Lang, IntentStrings> = {
  "hi-IN": { title: "हम कैसे मदद करें?", someoneLost: "कोई खो गया है", someoneLostSub: "मेरे साथ का कोई बिछड़ गया", iAmLost: "मैं खुद खो गया हूँ", iAmLostSub: "मुझे मेरे लोगों तक पहुँचाओ", nearby: "पास के खोया-पाया केंद्र", locating: "आपकी जगह ढूँढ रहे हैं…", away: "दूर", directions: "रास्ता", selfTitle: "घबराइए मत — आप सुरक्षित हैं", selfSub: "नज़दीकी केंद्र पर जाइए। स्टाफ़ आपके परिवार से मिलाएगा।", registerHere: "मुझे यहाँ दर्ज करें", registering: "दर्ज कर रहे हैं…", registeredTitle: "आप दर्ज हो गए", registeredSub: "यहीं रुकिए। स्टाफ़ आपके परिवार से मिलाएगा।", back: "वापस" },
  "mr-IN": { title: "आम्ही कशी मदत करू?", someoneLost: "कोणी हरवले आहे", someoneLostSub: "माझ्यासोबतचे कोणी बिछडले", iAmLost: "मी स्वतः हरवलो आहे", iAmLostSub: "मला माझ्या माणसांपर्यंत पोहोचवा", nearby: "जवळची खोया-पाया केंद्रे", locating: "तुमचे ठिकाण शोधत आहोत…", away: "दूर", directions: "रस्ता", selfTitle: "घाबरू नका — तुम्ही सुरक्षित आहात", selfSub: "जवळच्या केंद्रावर जा. कर्मचारी तुम्हाला कुटुंबाशी भेटवतील.", registerHere: "मला इथे नोंदवा", registering: "नोंदवत आहोत…", registeredTitle: "तुमची नोंद झाली", registeredSub: "इथेच थांबा. कर्मचारी तुम्हाला कुटुंबाशी भेटवतील.", back: "मागे" },
  "ta-IN": { title: "நாங்கள் எப்படி உதவ?", someoneLost: "யாரோ தொலைந்துவிட்டார்", someoneLostSub: "என்னுடன் வந்தவர் காணவில்லை", iAmLost: "நானே தொலைந்துவிட்டேன்", iAmLostSub: "என் ஆட்களிடம் சேர்க்க உதவுங்கள்", nearby: "அருகிலுள்ள உதவி மையங்கள்", locating: "உங்கள் இடத்தைத் தேடுகிறோம்…", away: "தொலைவில்", directions: "வழி", selfTitle: "பயப்படாதீர்கள் — நீங்கள் பாதுகாப்பாக உள்ளீர்கள்", selfSub: "அருகிலுள்ள மையத்திற்குச் செல்லுங்கள். பணியாளர் உங்கள் குடும்பத்துடன் சேர்ப்பார்.", registerHere: "என்னை இங்கே பதிவு செய்", registering: "பதிவு செய்கிறோம்…", registeredTitle: "நீங்கள் பதிவாகிவிட்டீர்கள்", registeredSub: "இங்கேயே இருங்கள். பணியாளர் உங்கள் குடும்பத்துடன் சேர்ப்பார்.", back: "பின்" },
  "te-IN": { title: "మేము ఎలా సహాయం చేయాలి?", someoneLost: "ఎవరో తప్పిపోయారు", someoneLostSub: "నాతో ఉన్నవారు తప్పిపోయారు", iAmLost: "నేనే తప్పిపోయాను", iAmLostSub: "నా వాళ్ళ దగ్గరకు చేర్చండి", nearby: "సమీప సహాయ కేంద్రాలు", locating: "మీ స్థలాన్ని వెతుకుతున్నాం…", away: "దూరం", directions: "దారి", selfTitle: "భయపడకండి — మీరు సురక్షితం", selfSub: "సమీప కేంద్రానికి వెళ్లండి. సిబ్బంది మిమ్మల్ని కుటుంబంతో కలుపుతారు.", registerHere: "నన్ను ఇక్కడ నమోదు చేయండి", registering: "నమోదు చేస్తున్నాం…", registeredTitle: "మీరు నమోదయ్యారు", registeredSub: "ఇక్కడే ఉండండి. సిబ్బంది మిమ్మల్ని కుటుంబంతో కలుపుతారు.", back: "వెనుకకు" },
  "bn-IN": { title: "আমরা কীভাবে সাহায্য করব?", someoneLost: "কেউ হারিয়ে গেছে", someoneLostSub: "আমার সঙ্গের কেউ হারিয়ে গেছে", iAmLost: "আমি নিজেই হারিয়ে গেছি", iAmLostSub: "আমাকে আমার লোকেদের কাছে পৌঁছে দিন", nearby: "কাছের সহায়তা কেন্দ্র", locating: "আপনার অবস্থান খুঁজছি…", away: "দূরে", directions: "পথ", selfTitle: "ভয় পাবেন না — আপনি নিরাপদ", selfSub: "কাছের কেন্দ্রে যান। কর্মীরা আপনাকে পরিবারের সাথে মিলিয়ে দেবেন।", registerHere: "আমাকে এখানে নথিভুক্ত করুন", registering: "নথিভুক্ত করছি…", registeredTitle: "আপনি নথিভুক্ত হয়েছেন", registeredSub: "এখানেই থাকুন। কর্মীরা আপনাকে পরিবারের সাথে মিলিয়ে দেবেন।", back: "পিছনে" },
  "gu-IN": { title: "અમે કેવી રીતે મદદ કરીએ?", someoneLost: "કોઈ ખોવાઈ ગયું છે", someoneLostSub: "મારી સાથેનું કોઈ વિખૂટું પડ્યું", iAmLost: "હું પોતે ખોવાઈ ગયો છું", iAmLostSub: "મને મારા લોકો સુધી પહોંચાડો", nearby: "નજીકના ખોયા-પાયા કેન્દ્રો", locating: "તમારું સ્થાન શોધી રહ્યા છીએ…", away: "દૂર", directions: "રસ્તો", selfTitle: "ગભરાશો નહીં — તમે સુરક્ષિત છો", selfSub: "નજીકના કેન્દ્ર પર જાઓ. સ્ટાફ તમને પરિવાર સાથે મેળવશે.", registerHere: "મને અહીં નોંધો", registering: "નોંધી રહ્યા છીએ…", registeredTitle: "તમારી નોંધ થઈ", registeredSub: "અહીં જ રહો. સ્ટાફ તમને પરિવાર સાથે મેળવશે.", back: "પાછળ" },
  "kn-IN": { title: "ನಾವು ಹೇಗೆ ಸಹಾಯ ಮಾಡೋಣ?", someoneLost: "ಯಾರೋ ಕಳೆದುಹೋಗಿದ್ದಾರೆ", someoneLostSub: "ನನ್ನ ಜೊತೆಯವರು ಕಳೆದುಹೋಗಿದ್ದಾರೆ", iAmLost: "ನಾನೇ ಕಳೆದುಹೋಗಿದ್ದೇನೆ", iAmLostSub: "ನನ್ನ ಜನರ ಬಳಿ ಸೇರಿಸಿ", nearby: "ಹತ್ತಿರದ ಸಹಾಯ ಕೇಂದ್ರಗಳು", locating: "ನಿಮ್ಮ ಸ್ಥಳವನ್ನು ಹುಡುಕುತ್ತಿದ್ದೇವೆ…", away: "ದೂರ", directions: "ದಾರಿ", selfTitle: "ಭಯಪಡಬೇಡಿ — ನೀವು ಸುರಕ್ಷಿತ", selfSub: "ಹತ್ತಿರದ ಕೇಂದ್ರಕ್ಕೆ ಹೋಗಿ. ಸಿಬ್ಬಂದಿ ನಿಮ್ಮನ್ನು ಕುಟುಂಬದೊಂದಿಗೆ ಸೇರಿಸುತ್ತಾರೆ.", registerHere: "ನನ್ನನ್ನು ಇಲ್ಲಿ ನೋಂದಾಯಿಸಿ", registering: "ನೋಂದಾಯಿಸುತ್ತಿದ್ದೇವೆ…", registeredTitle: "ನೀವು ನೋಂದಾಯಿಸಲ್ಪಟ್ಟಿದ್ದೀರಿ", registeredSub: "ಇಲ್ಲೇ ಇರಿ. ಸಿಬ್ಬಂದಿ ನಿಮ್ಮನ್ನು ಕುಟುಂಬದೊಂದಿಗೆ ಸೇರಿಸುತ್ತಾರೆ.", back: "ಹಿಂದೆ" },
  "ml-IN": { title: "ഞങ്ങൾ എങ്ങനെ സഹായിക്കണം?", someoneLost: "ആരോ കാണാതായി", someoneLostSub: "എന്റെ കൂടെയുള്ളയാൾ കാണാതായി", iAmLost: "ഞാൻ തന്നെ വഴിതെറ്റി", iAmLostSub: "എന്റെ ആളുകളുടെ അടുത്ത് എത്തിക്കൂ", nearby: "അടുത്തുള്ള സഹായ കേന്ദ്രങ്ങൾ", locating: "നിങ്ങളുടെ സ്ഥലം കണ്ടെത്തുന്നു…", away: "അകലെ", directions: "വഴി", selfTitle: "പേടിക്കേണ്ട — നിങ്ങൾ സുരക്ഷിതരാണ്", selfSub: "അടുത്തുള്ള കേന്ദ്രത്തിലേക്ക് പോകൂ. ജീവനക്കാർ നിങ്ങളെ കുടുംബവുമായി ചേർക്കും.", registerHere: "എന്നെ ഇവിടെ രജിസ്റ്റർ ചെയ്യൂ", registering: "രജിസ്റ്റർ ചെയ്യുന്നു…", registeredTitle: "നിങ്ങൾ രജിസ്റ്റർ ചെയ്തു", registeredSub: "ഇവിടെ തന്നെ നിൽക്കൂ. ജീവനക്കാർ നിങ്ങളെ കുടുംബവുമായി ചേർക്കും.", back: "പുറകോട്ട്" },
  "en-IN": { title: "How can we help?", someoneLost: "Someone is lost", someoneLostSub: "Someone with me is missing", iAmLost: "I am lost", iAmLostSub: "Help me reach my people", nearby: "Nearby help desks", locating: "Finding your location…", away: "away", directions: "Directions", selfTitle: "Don't panic — you are safe", selfSub: "Go to the nearest help desk. Staff will reunite you with your family.", registerHere: "Register me here", registering: "Registering…", registeredTitle: "You're registered", registeredSub: "Stay here. Staff will reunite you with your family.", back: "Back" },
};

export const ENINTENT = INTENT["en-IN"];

export function intent(lang: Lang): IntentStrings {
  return INTENT[lang] ?? INTENT["hi-IN"];
}
